...
CREATE TABLE "Account" (
    ...
    "remoteLoginHandle" TEXT,
    "remoteMachineId" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "Account_remoteLoginHandle_key" ON "Account"("remoteLoginHandle");

-- CreateIndex
CREATE UNIQUE INDEX "Account_remoteMachineId_key" ON "Account"("remoteMachineId");
