  ...
  app.get(
    ...
    async (request, reply) => {
      ...
      return reply.send({
        ...
        avatar: user.avatar
          ? { ...user.avatar, url: getPublicUrl(user.avatar.path) }
          : null,
    ...
    async (request, reply) => {
      try {
        ...
        if (!user) {
          return reply
            .code(500)
            .send({ error: "Failed to get account settings" });
        }
    ...
    async (request, reply) => {
      ...
      try {
        ...
        log(
          ...
          `Failed to update account settings: ${error}`,
        );
        return reply.code(500).send({
          success: false,
          error: "Failed to update account settings",
  ...
  app.post(
    ...
    async (request, reply) => {
      ...
      try {
        ...
        log(
          { module: "api", level: "error" },
          `Failed to query usage reports: ${error}`,
        );
